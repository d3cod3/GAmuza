  ...
  if ((b = luaV_tonumber(rb, &tempb)) != NULL &&
    ...
    switch (op) {
      ...
      case TM_UNM: setnvalue(ra, luai_numunm(nb)); break;
                ...
                case TM_ADDMUTATE: setnvalue(ra, luai_numadd(nb, nc)); break;
            #endif
...
#if defined(LUA_BITWISE_OPERATORS)
static void Logic (lua_State *L, StkId ra, const TValue *rb, const TValue *rc, TMS op) {
      TValue tempb, tempc;
      const TValue *b, *c;
      if ((b = luaV_tonumber(rb, &tempb)) != NULL &&
                 (c = luaV_tonumber(rc, &tempc)) != NULL) {
    ...
    switch (GET_OPCODE(i)) {
      ...
      case OP_UNM: {
        ...
        continue;
                  ...
                  case OP_ADDMUTATE: {
                      arith_op(luai_numadd, TM_ADDMUTATE);
                      continue;
                  }
            #endif
