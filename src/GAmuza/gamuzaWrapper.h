...
class ofGamuzaWrapper{
	...
	static void bind(ofxLua& lua) {
		...
		/// OpenFrameworks 0.7.4 addons api wrapper
         ...
         //////////////////////////////////////////////////////////////////////////////////////////////////
         // OFXIPVIDEOGRABBER
         class_<IPCameraDef>("IPCameraDef")
         .def(constructor<>())
         .def(constructor<string>())
         .def(constructor<string,string,string,string>()),
         
         class_<ofxIpVideoGrabber>("ofxIpVideoGrabber")
         .def(constructor<>())
         .def("update", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::update)
         .def("connect", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::connect)
         .def("disconnect", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::disconnect)
         .def("waitForDisconnect", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::waitForDisconnect)
         .def("isFrameNew", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::isFrameNew)
         .def("close", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::close)
         .def("reset", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::reset)
         .def("getPixelsRef", (ofPixelsRef(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getPixelsRef)
         .def("getTextureReference", (ofTexture&(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getTextureReference)
         .def("setUseTexture", (void(ofxIpVideoGrabber::*)(bool)) &ofxIpVideoGrabber::setUseTexture)
         .def("draw", (void(ofxIpVideoGrabber::*)(float,float)) &ofxIpVideoGrabber::draw)
         .def("draw", (void(ofxIpVideoGrabber::*)(float,float,float,float)) &ofxIpVideoGrabber::draw)
         .def("draw", (void(ofxIpVideoGrabber::*)(const ofPoint&)) &ofxIpVideoGrabber::draw)
         .def("draw", (void(ofxIpVideoGrabber::*)(const ofRectangle&)) &ofxIpVideoGrabber::draw)
         .def("setAnchorPercent", (void(ofxIpVideoGrabber::*)(float,float)) &ofxIpVideoGrabber::setAnchorPercent)
         .def("setAnchorPoint", (void(ofxIpVideoGrabber::*)(float,float)) &ofxIpVideoGrabber::setAnchorPoint)
         .def("resetAnchor", (void(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::resetAnchor)
         .def("getWidth", (float(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getWidth)
         .def("getHeight", (float(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getHeight)
         .def("getNumFramesReceived", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getNumFramesReceived)
         .def("getNumBytesReceived", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getNumBytesReceived)
         .def("getFrameRate", (float(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getFrameRate)
         .def("getBitRate", (float(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getBitRate)
         .def("getCameraName", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getCameraName)
         .def("setCameraName", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setCameraName)
         .def("setURI", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setURI)
         .def("getURI", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getURI)
         .def("getHost", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getHost)
         .def("getQuery", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getQuery)
         .def("getPort", (int(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getPort)
         .def("getFragment", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getFragment)
         .def("setCookie", (void(ofxIpVideoGrabber::*)(const string&,const string&)) &ofxIpVideoGrabber::setCookie)
         .def("eraseCookie", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::eraseCookie)
         .def("getCookie", (string(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::getCookie)
         .def("setUsername", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setUsername)
         .def("setPassword", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setPassword)
         .def("getUsername", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getUsername)
         .def("getPassword", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getPassword)
         .def("setUseProxy", (void(ofxIpVideoGrabber::*)(bool)) &ofxIpVideoGrabber::setUseProxy)
         .def("setProxyUsername", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setProxyUsername)
         .def("setProxyPassword", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setProxyPassword)
         .def("setProxyHost", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setProxyHost)
         .def("setProxyPort", (void(ofxIpVideoGrabber::*)(UInt16)) &ofxIpVideoGrabber::setProxyPort)
         .def("getUseProxy", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getUseProxy)
         .def("getProxyUsername", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getProxyUsername)
         .def("getProxyPassword", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getProxyPassword)
         .def("getProxyHost", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getProxyHost)
         .def("getProxyPort", (UInt16(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getProxyPort)
         .def("isConnected", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::isConnected)
         .def("hasConnectionFailed", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::hasConnectionFailed)
         .def("setReconnectTimeout", (void(ofxIpVideoGrabber::*)(unsigned long)) &ofxIpVideoGrabber::setReconnectTimeout)
         .def("getReconnectTimeout", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getReconnectTimeout)
         .def("getNeedsReconnect", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getNeedsReconnect)
         .def("getAutoReconnect", (bool(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getAutoReconnect)
         .def("getReconnectCount", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getReconnectCount)
         .def("getMaxReconnects", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getMaxReconnects)
         .def("setMaxReconnects", (void(ofxIpVideoGrabber::*)(unsigned long)) &ofxIpVideoGrabber::setMaxReconnects)
         .def("getAutoRetryDelay", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getAutoRetryDelay)
         .def("setAutoRetryDelay", (void(ofxIpVideoGrabber::*)(unsigned long)) &ofxIpVideoGrabber::setAutoRetryDelay)
         .def("getNextAutoRetryTime", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getNextAutoRetryTime)
         .def("getTimeTillNextAutoRetry", (unsigned long(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getTimeTillNextAutoRetry)
         .def("setDefaultBoundaryMarker", (void(ofxIpVideoGrabber::*)(const string&)) &ofxIpVideoGrabber::setDefaultBoundaryMarker)
         .def("getDefaultBoundaryMarker", (string(ofxIpVideoGrabber::*)(void)) &ofxIpVideoGrabber::getDefaultBoundaryMarker),
         //////////////////////////////////////////////////////////////////////////////////////////////////
