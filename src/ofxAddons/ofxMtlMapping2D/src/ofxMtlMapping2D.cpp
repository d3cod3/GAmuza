...
void ofxMtlMapping2D::draw()
{
    ...
    ofxMtlMapping2DControls::mapping2DControls()->draw();
}

void ofxMtlMapping2D::toggle(){
...
//--------------------------------------------------------------
void ofxMtlMapping2D::renderInsideFBO()
{
    list<ofxMtlMapping2DShape*>::iterator it;
...
//--------------------------------------------------------------
ofFbo ofxMtlMapping2D::getMappedFBO(){
    return _fbo;
}
...
//--------------------------------------------------------------
void ofxMtlMapping2D::mouseMoved(int x, int y)
{
    ofxMtlMapping2DControls::mapping2DControls()->mouseMoved(x,y);
    
}

//--------------------------------------------------------------
void ofxMtlMapping2D::mouseDragged(int x, int y, int button)
{
    ofxMtlMapping2DControls::mapping2DControls()->mouseDragged(x,y,button);
...
void ofxMtlMapping2D::mousePressed(ofMouseEventArgs &e){
    ...
    list<ofxMtlMapping2DShape*>::iterator nt;
    for (nt=ofxMtlMapping2DShapes::pmShapes.begin(); nt!=ofxMtlMapping2DShapes::pmShapes.end(); nt++) {
        ofxMtlMapping2DShape* shape = *nt;
        ...
        if(grabbedOne) {
            // Put active shape at the top of the list
            ofxMtlMapping2DShapes::pmShapes.push_front(shape);
            ofxMtlMapping2DShapes::pmShapes.erase(nt);
...
void ofxMtlMapping2D::mousePressed(int x, int y, int button)
{
    ...
    ofxMtlMapping2DControls::mapping2DControls()->mousePressed(x,y,button);
    
}

//--------------------------------------------------------------
void ofxMtlMapping2D::mouseReleased(int x, int y, int button)
{
    ofxMtlMapping2DControls::mapping2DControls()->mouseReleased(x,y,button);
