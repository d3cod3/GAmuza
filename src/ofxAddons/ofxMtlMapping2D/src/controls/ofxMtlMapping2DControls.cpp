...
void ofxMtlMapping2DControls::resizeShapeList()
{
    ...
    if(listHeight < 720) {
        _shapesListCanvas->getRect()->setHeight(720);
    } else {
...
//--------------------------------------------------------------
void ofxMtlMapping2DControls::update(){
    _toolsCanvas->update();
    _shapesListCanvas->update();
    _gridSettingsCanvas->update();
}

//--------------------------------------------------------------
void ofxMtlMapping2DControls::draw(){
    _toolsCanvas->draw();
    _shapesListCanvas->draw();
    _gridSettingsCanvas->draw();
}

//--------------------------------------------------------------
void ofxMtlMapping2DControls::mouseMoved(int x, int y ){
    _toolsCanvas->mouseMoved(x,y);
    _shapesListCanvas->mouseMoved(x,y);
    _gridSettingsCanvas->mouseMoved(x,y);
}

//--------------------------------------------------------------
void ofxMtlMapping2DControls::mouseDragged(int x, int y, int button){
    _toolsCanvas->mouseDragged(x,y,button);
    _shapesListCanvas->mouseDragged(x,y,button);
    _gridSettingsCanvas->mouseDragged(x,y,button);
}

//--------------------------------------------------------------
void ofxMtlMapping2DControls::mousePressed(int x, int y, int button){
    _toolsCanvas->mousePressed(x,y,button);
    _shapesListCanvas->mousePressed(x,y,button);
    _gridSettingsCanvas->mousePressed(x,y,button);
    
    
}

//--------------------------------------------------------------
void ofxMtlMapping2DControls::mouseReleased(int x, int y, int button){
    _toolsCanvas->mouseReleased(x,y,button);
    _shapesListCanvas->mouseReleased(x,y,button);
    _gridSettingsCanvas->mouseReleased(x,y,button);
}
